...
bsub -J 'rna[1-321]' -W 2:30 -e output_logs/rna_%I.err -o output_logs/rna_%I.out sh scripts/rna_elbows.sh

bsub -J 'rna[321-481]' -W 2:30 -e output_logs/rna_%I.err -o output_logs/rna_%I.out sh scripts/rna_elbows.sh
